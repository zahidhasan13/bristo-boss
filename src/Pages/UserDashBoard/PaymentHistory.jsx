...
const PaymentHistory = () => {
  ...
  return (
    <div>
      ...
      ></SectionTitle>
      <div>
        <div className="flex justify-between items-center mb-10 lg:pl-16 px-4 xl:pl-0">
        ...
        <div>
          <div className="overflow-x-auto lg:pl-16 lg:pr-4 px-4 xl:pl-0">
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {payment.map((pay) => (
                  <tr className="border-b dark:border-gray-700" key={pay._id}>
                    <th
                      scope="row"
                    ...
                    <td className="px-4 py-3">{pay.transactionId}</td>
                    <td className="px-4 py-3">{pay.quantity}</td>
                    ...
                    <td className="px-4 py-3">${pay.price}</td>
                  </tr>
                ))}
              </tbody>
            </table>
